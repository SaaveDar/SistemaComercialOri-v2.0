...
Public Class cr_filtrogrupos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.cr_filtrogrupos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_filtrogrupos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_filtrogrupos = New cr_filtrogrupos()
        rpt.Site = Me.Site
        Return rpt
    End Function
