...
Public Class FormMessageBox
    'Fields
    Private _primaryColor As Color = ColorTranslator.FromHtml(strColorLogin)
    'ColorTranslator.FromHtml(strColorLogin)
    ...
    Private Sub SetButtons(buttons As MessageBoxButtons, defaultButton As MessageBoxDefaultButton)
        ...
        Select Case buttons
            ...
            Case MessageBoxButtons.YesNo
                ...
                button1.BackColor = System.Drawing.ColorTranslator.FromHtml(strColorAzul) 'Color.IndianRed
                'No Button
                button2.Visible = True
                button2.Location = New Point(xCenter + (button2.Width / 2) + 5, yCenter)
                button2.Text = "No"
                button2.DialogResult = DialogResult.No 'Set DialogResult
                button2.BackColor = System.Drawing.ColorTranslator.FromHtml(strColorRojo) 'Color.IndianRed
    ...
    Private Sub SetIcon(icon As MessageBoxIcon)
        Select Case icon
            Case MessageBoxIcon.Error
                ...
                PrimaryColor = ColorTranslator.FromHtml(strColorLogin)
